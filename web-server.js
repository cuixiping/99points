...
//var serverInfo = 'node-static/' + conf.env.nodeStaticVersion;
var serverInfo = 'Ninety Nine Points / version ' + conf.env.version;
...
this.Server.prototype.serve = function (req, res, callback) {
    ...
    if( typeof conf.mappingTable[pathname] === 'string') { pathname = conf.mappingTable[pathname]; }
...
this.Server.prototype.respond = function (pathname, status, _headers, files, stat, req, res, finish) {
    ...
    if (req.headers['if-none-match'] === headers['Etag'] ||
        ...
        if (this.cache && (exports.store[key]) &&
